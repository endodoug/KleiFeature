...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "FeatureSlider_edge.js"},
      { load: "FeatureSlider_edgeActions.js"}];
...
var plSTF="width",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="1570px",plHeight="523px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['741', '218','88px','88px','auto', 'auto'],
